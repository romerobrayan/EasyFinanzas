...
/**
 * Aggregates EXPENSE transactions into the dashboard chart buckets. The last
 * bucket is the one containing [anchor]; earlier buckets walk backwards at the
 * granularity of [period]. Bucketing is date math here — not SQL — so it stays
 * testable and locale-safe.
 */
